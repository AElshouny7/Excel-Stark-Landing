...
export const site = {
  ...
  contactEmail: "information@excelstark.com",
  ...
  metrics: <Metric[]>[
    {
      label: "Leak sites sealed",
      value: "10,000+",
      helper: "On-line & offline",
    },
    {
      label: "Countries supported",
      value: "30+",
      helper: "Across MENA & beyond",
    },
    {
      label: "First-time success",
      value: "98.9%",
      helper: "Engineered repairs",
    },
  ...
  productSystems: [
    ...
    },
    {
      ...
      typicalUse:
        "Rapid leak reduction on small-bore piping and low-to-medium pressure lines.",
    },
    {
